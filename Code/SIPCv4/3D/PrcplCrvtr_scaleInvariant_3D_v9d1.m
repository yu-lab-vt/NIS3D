function [curvature_merged,FGmap,curvature_all]=PrcplCrvtr_scaleInvariant_3D_v9d1(dat,smFactorLst,zRatio,BG)
...
curvature_merged2 = min(curvature_all_modified,[],4);
BGmap=curvature_merged2>-abs(zThres);
FGmap=~BGmap;
for smCnt=1:N_smNum
    temp=curvature_all_modified(:,:,:,smCnt);
