function [curvature_merged,FGmap,curvature_all]=PrcplCrvtr_scaleInvariant_3D_v8(dat,smFactorLst,zRatio,BG)
...
PatchSzX=floor(gpuDevice().AvailableMemory/4/11/(Y*Z))-2*Roverlap;
